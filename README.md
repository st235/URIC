...
A Uniform Resource Identifier implementation for `c++`. The implementation is done strictly with accordance to [RFC 3986](https://datatracker.ietf.org/doc/html/rfc3986).
...
>[!NOTE]
>If `RFC 3986` is not available for some reason, you can use [the local copy](./rfc3986.pdf).
