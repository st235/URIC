...
class UriParserHierPartTestingFixture: public ::testing::TestWithParam<ValidationData> {};
...
TEST_P(UriParserHierPartTestingFixture, TestThatHierPartParsingIsCorrect) {
    ...
    EXPECT_EQ(uri::__internal::hierPart(reader) && !reader.hasNext(), expected_result);
}
