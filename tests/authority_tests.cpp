...
INSTANTIATE_TEST_SUITE_P(
        ...
        ::testing::Values(
            ...
            std::make_pair(Authority("111.214.215.218", "54506"), "111.214.215.218:54506"),
            std::make_pair(Authority("147.11.235.42", "62447"), "147.11.235.42:62447"),
            std::make_pair(Authority("8e4d:b902:92d5:8f3:9ef7:f1dc:1218:d84a", std::nullopt, std::nullopt, /* isHostIPLiteral= */ true), "[8e4d:b902:92d5:8f3:9ef7:f1dc:1218:d84a]"),
            std::make_pair(Authority("206.184.19.245", "46529"), "206.184.19.245:46529"),
            std::make_pair(Authority("62f:a49e:5dfa:cca7:ccd8:55fe:8806:bf69", std::nullopt, "court", /* isHostIPLiteral= */ true), "court@[62f:a49e:5dfa:cca7:ccd8:55fe:8806:bf69]"),
            ...
            std::make_pair(Authority("e08b:cb59:5a3:4a76:bd46:860d:b5fe:e3b8", std::nullopt, std::nullopt, /* isHostIPLiteral= */ true), "[e08b:cb59:5a3:4a76:bd46:860d:b5fe:e3b8]"),
            std::make_pair(Authority("68.237.55.210", "40313", "security"), "security@68.237.55.210:40313"),
            std::make_pair(Authority("kelley.lewis.com"), "kelley.lewis.com"),
            std::make_pair(Authority("86b8:36cd:d44a:bcf3:b347:3:bab8:8ec0", std::nullopt, std::nullopt, /* isHostIPLiteral= */ true), "[86b8:36cd:d44a:bcf3:b347:3:bab8:8ec0]"),
            std::make_pair(Authority("143.158.94.161", "1848", "establish"), "establish@143.158.94.161:1848"),
            std::make_pair(Authority("83.234.161.14"), "83.234.161.14"),
            std::make_pair(Authority("pena.mcclure.com", std::nullopt, "explain"), "explain@pena.mcclure.com"),
            std::make_pair(Authority("c184:7b30:52c9:7ba8:507f:a089:832f:5a9f", std::nullopt, "all", /* isHostIPLiteral= */ true), "all@[c184:7b30:52c9:7ba8:507f:a089:832f:5a9f]"),
            ...
            std::make_pair(Authority("188.183.6.140"), "188.183.6.140"),
            std::make_pair(Authority("155.63.194.228", "47036"), "155.63.194.228:47036"),
            std::make_pair(Authority("101.15.93.234", "21475"), "101.15.93.234:21475"),
            std::make_pair(Authority("177.36.52.78", "56948"), "177.36.52.78:56948"),
            std::make_pair(Authority("pena.com"), "pena.com"),
            std::make_pair(Authority("hernandez-reid.estes.harmon.com"), "hernandez-reid.estes.harmon.com"),
            std::make_pair(Authority("177.28.61.252"), "177.28.61.252"),
            std::make_pair(Authority("208.211.234.22", "52177"), "208.211.234.22:52177"),
            std::make_pair(Authority("222.226.4.28", std::nullopt, "land"), "land@222.226.4.28"),
            std::make_pair(Authority("148.168.247.196"), "148.168.247.196"),
            std::make_pair(Authority("190.228.65.248"), "190.228.65.248"),
            std::make_pair(Authority("d21d:258c:3bd:4af3:a44a:d24f:9e8e:47c5", std::nullopt, "cup", /* isHostIPLiteral= */ true), "cup@[d21d:258c:3bd:4af3:a44a:d24f:9e8e:47c5]"),
            std::make_pair(Authority("71.226.240.166"), "71.226.240.166"),
            ...
            std::make_pair(Authority("b462:b319:f65f:a62b:4f7f:e7cc:d25a:2d7c", std::nullopt, "after", /* isHostIPLiteral= */ true), "after@[b462:b319:f65f:a62b:4f7f:e7cc:d25a:2d7c]"),
            std::make_pair(Authority("77.65.179.119", "49687", "black"), "black@77.65.179.119:49687"),
            std::make_pair(Authority("e6cf:50cc:568e:5aac:4cb4:d651:cb15:64c5", std::nullopt, std::nullopt, /* isHostIPLiteral= */ true), "[e6cf:50cc:568e:5aac:4cb4:d651:cb15:64c5]"),
            std::make_pair(Authority("183.12.209.160"), "183.12.209.160"),
            std::make_pair(Authority("129.130.93.27", "38028"), "129.130.93.27:38028"),
            ...
            std::make_pair(Authority("325f:1a72:13f5:e7bd:c05f:b5c6:638a:f1a8", std::nullopt, "item", /* isHostIPLiteral= */ true), "item@[325f:1a72:13f5:e7bd:c05f:b5c6:638a:f1a8]"),
            std::make_pair(Authority("154.90.189.39", std::nullopt, "now"), "now@154.90.189.39"),
            std::make_pair(Authority("8932:48ae:ef84:fa07:3501:d98f:b9ed:a954", std::nullopt, "case", /* isHostIPLiteral= */ true), "case@[8932:48ae:ef84:fa07:3501:d98f:b9ed:a954]"),
            std::make_pair(Authority("39.175.198.88"), "39.175.198.88"),
            std::make_pair(Authority("90.212.165.125"), "90.212.165.125"),
            std::make_pair(Authority("199.127.41.116"), "199.127.41.116")
        )
);
