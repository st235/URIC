...
class UriParserPathNoschemeTestingFixture: public ::testing::TestWithParam<ValidationData> {};
...
TEST_P(UriParserPathNoschemeTestingFixture, TestThatPathNoschemeParsingIsCorrect) {
    ...
    EXPECT_EQ(uri::__internal::pathNoscheme(reader) && !reader.hasNext(), expected_result);
}
